## Experiment with operating the lamp via Arduino and ESP :
### 1- Interlocking the pieces together :

![تشبيك1](https://github.com/user-attachments/assets/5c5f8c7a-e6a2-46aa-ae6e-098e60c6fc4a)


### 2- Put the code in the Arduino program: 
```
/* BasicHTTPClient.ino
 *
